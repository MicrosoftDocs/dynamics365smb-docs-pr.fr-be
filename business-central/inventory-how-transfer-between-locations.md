...
> [!NOTE]
> Pour transférer des articles, vous devez configurer des magasins et des acheminements transfert. Pour en savoir plus sur la configuration des emplacements, accédez à [Configurer des emplacements](inventory-how-setup-locations.md). Vous ne pouvez pas utiliser d’ordres de transfert pour des magasins *vides*.
...
Utiliser **la feuille reclassement article** pour :

* Transfert direct d’articles entre magasins.
...
4. Cliquez sur **Valider**, choisissez l'option **Expédition**, puis cliquez sur le bouton **OK**.
    ...
    Les articles sont à présent en transit entre les magasins spécifiés, selon l’acheminement transfert.
...
* La valeur du champ **Quantité expédiée** est diminuée de la quantité annulée.
* La valeur du champ **Quantité à expédier** est accrue de la quantité annulée.
