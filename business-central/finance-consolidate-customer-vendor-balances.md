...
Pour consolider les soldes, vous devez d’abord lier les sociétés client et fournisseur via un contact de type **Société**. Un client ou un fournisseur ne peut avoir qu’un seul contact du type **Société**. Pour plus d'informations, reportez-vous à [Créer des contacts](marketing-create-contact-companies.md).
...
1. Créez un client ou un fournisseur. Pour plus d'informations, reportez vous à [Enregistrer de nouveaux clients](sales-how-register-new-customers.md).
...
Sur la page **Feuille paiement**, utilisez l’action **Soldes client/fournisseur nets** pour consolider les soldes client/fournisseur en un seul montant net. L’action crée, mais ne publie pas, les lignes du journal des paiements qui contiennent les soldes nets.
