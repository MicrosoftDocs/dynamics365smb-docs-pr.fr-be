...
---
# <a name="run-and-print-reports-in-business-central"></a>Exécuter et imprimer des états
...
## <a name="specify-the-data-to-include-in-a-report"></a>Définition des données à inclure dans un état
...
## <a name="preview-a-report"></a>Affichage de l’aperçu d’un état
...
## <a name="save-a-report-to-a-file"></a>Enregistrement d’un état dans un fichier
...
## <a name="schedule-a-report-to-run-later-or-periodically"></a><a name="ScheduleReport"></a>Planification d’un état pour une exécution ultérieure ou périodique
...
## <a name="print-a-report"></a><a name="PrintReport"></a>Impression d’un état
...
### <a name="print-reports-in-thai"></a>Impression d’états en thaïlandais
...
## <a name="switch-the-report-layout"></a>Modifier la présentation de l’état
