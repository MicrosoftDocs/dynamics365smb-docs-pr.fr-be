...
---
# <a name="walkthrough-set-up-and-invoicing-sales-prepayments"></a>Procédure pas à pas : Configurer et facturer des acomptes vente
...
1. Sélectionnez ![icône en forme d’Ampoule qui ouvre la fenêtre de recherche.](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire") entrez **Commandes vente**, puis sélectionnez le lien associé.  
...
1. Sélectionnez ![l’icône en forme d’Ampoule qui ouvre la fenêtre de recherche](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire"), entrez **Feuilles règlement**, puis choisissez le lien associé.  
