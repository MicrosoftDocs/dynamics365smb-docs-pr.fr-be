...
| À | Voir |
| --- | --- |
| Créez une fiche fournisseur pour chaque fournisseur auquel vous achetez des biens. |[Enregistrement des nouveaux fournisseurs](purchasing-how-register-new-vendors.md) |
| Octroyez une priorité aux fournisseurs. |[Classement par ordre de priorité des fournisseurs](purchasing-how-prioritize-vendors.md) |
| Entrez les informations de compte bancaire, y compris les codes IBAN et SWIFT, sur la carte de votre fournisseur. | [Configuration des comptes bancaires fournisseur](purchasing-how-set-up-vendors-bank-accounts.md) |
| Configurez des acheteurs, affectez-leur des fournisseurs et des codes pour suivre les statistiques. |[Configuration des acheteurs](purchasing-how-setup-purchasers.md) |
...
| Définissez ce que vous payez pour les articles et services achetés par votre entreprise.  | [Configuration des prix et remises](across-prices-and-discounts.md) |
...
| Examinez les reçus de dépenses, convertissez les documents papier et électroniques en lignes de journal et numérisez les factures papier des fournisseurs. | [Paramétrage des documents entrants](across-how-setup-income-documents.md) |
