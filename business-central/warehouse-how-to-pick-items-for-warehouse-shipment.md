...
## <a name="check-whether-items-are-available-for-picking"></a>Pour créer des documents de prélèvement en bloc avec la feuille prélèvement
...
## <a name="to-create-pick-documents-in-bulk-with-the-pick-worksheet"></a>Pour prélever des articles pour une expédition entrepôt
...
## <a name="to-pick-items-for-a-warehouse-shipment"></a>Voir la [formation Microsoft](/training/modules/pick-ship-items-warehouse/) associée
