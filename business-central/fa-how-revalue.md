...
## <a name="to-post-other-acquisition-costs"></a>Pour valider les coûts d’acquisition supplémentaires
...
### <a name="example---posting-other-acquisition-costs"></a>Exemple - Valider des coûts d’acquisition supplémentaires
