...
---
# <a name="power-bi-integration-component-and-architecture-overview"></a>Vue d’ensemble Architecture et composant d’intégration Power BI pour [!INCLUDE[prod_short](includes/prod_short.md)]
