...
Les étapes suivantes supposent que vous avez déjà configuré les groupes comptabilisation dans la page **Groupes compta. immo**. Pour plus d’informations, reportez vous à [Pour configurer des groupes de validation immobilisation](fa-how-setup-general.md#to-set-up-fixed-asset-posting-groups).  
