...
1. Sélectionnez l’icône ![Ampoule qui ouvre la fenêtre de recherche.](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire") entrez **Rapprochement bancaire**, puis sélectionnez le lien associé.
...
|Champ  |Description  |
|---------|---------|
|Date de relevé| La date spécifiée dans le champ **Date du relevé** sur la page **Rapprochement bancaire**.|
...
3. Renseignez la ligne feuille avec les informations, comme le compte de contrepartie. Pour en savoir plus, reportez-vous à [Utiliser des feuilles comptabilité](ui-work-general-journals.md).  
