...
|---------------------|--------------------|  
|Ordre de production|Sur la page **Ordre de fabrication planifié**, changez le statut d’une commande en **Lancé** , ou utilisez la page **Ordre de fabrication lancé**pour créer un ordre de fabrication lancé.|  
