...
1. Définissez la colonne **Entreprise** pour appliquer l’ensembles d’autorisations à une entreprise spécifique uniquement. Si vous souhaitez que l’ensemble d’autorisations s’applique à toutes les entreprises, laissez la colonne **Entreprise** champ vide. [En savoir plus](ui-define-granular-permissions.md#control-access-to-specific-companies).
