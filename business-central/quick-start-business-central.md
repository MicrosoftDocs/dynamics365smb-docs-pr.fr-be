...
La première étape consiste à fournir les informations de base sur votre entreprise. Les informations telles que l’adresse, les comptes bancaires, le numéro de TVA, etc. Pour en savoir plus, reportez-vous à [Démarrage rapide Informations société](quick-start-company-information.md).
...
Comment personnaliser et imprimer des états et des documents tels que des factures de vente pour répondre aux besoins de votre entreprise dans [Démarrage rapide de la sortie de états et documents de base](quick-start-reports-and-documents.md).
