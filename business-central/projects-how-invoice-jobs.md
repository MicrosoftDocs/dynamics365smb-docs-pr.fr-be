...
## <a name="to-create-and-post-project-sales-invoice-from-project-planning-lines"></a>Pour créer et valider une facture vente projet à partir de lignes planning projet
