...
- Ligne de service (sauf pour les avoirs de service, où vous verrez une notification indiquant que l’article ou la variante est bloqué, mais autorisé sur ce type de document)
- Article de service
- Ligne contrat service
- Ligne service standard
...
- **Valider** dans page la **facture service**.
...
- Ligne d’article de service (sauf pour les avoirs de service, si bloqués pour tous)
