...
ms.locfileid: "5788015"
---
# <a name="modify-planning-suggestions-in-a-graphical-view"></a><span data-ttu-id="0df63-104">Modifier les propositions planning dans une vue graphique</span><span class="sxs-lookup"><span data-stu-id="0df63-104">Modify Planning Suggestions in a Graphical View</span></span>

<span data-ttu-id="0df63-105">Une activité de planification courante est d’ajouter ou de modifier les lignes feuille planning pour modifier les commandes approvisionnement proposées avant de les valider en exécutant la fonction **Traiter message d’action**.</span><span class="sxs-lookup"><span data-stu-id="0df63-105">A typical planning activity is to change or add planning worksheet lines to modify the suggested supply orders before you commit them by running the **Carry out Action Message** function.</span></span> <span data-ttu-id="0df63-106">Une alternative à utiliser la feuille planning est d’utiliser une vue graphique.</span><span class="sxs-lookup"><span data-stu-id="0df63-106">An alternative to doing this in the planning worksheet is to use a graphical view.</span></span> <span data-ttu-id="0df63-107">Cependant, ceci n’est actuellement pas pris en charge dans [!INCLUDE[prod_short](includes/prod_short.md)].</span><span class="sxs-lookup"><span data-stu-id="0df63-107">However, this is currently not supported in [!INCLUDE[prod_short](includes/prod_short.md)].</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="0df63-108">Voir aussi</span><span class="sxs-lookup"><span data-stu-id="0df63-108">See Also</span></span>

[<span data-ttu-id="0df63-109">Planifié</span><span class="sxs-lookup"><span data-stu-id="0df63-109">Planning</span></span>](production-planning.md)  
[<span data-ttu-id="0df63-110">Paramétrage de la production</span><span class="sxs-lookup"><span data-stu-id="0df63-110">Setting Up Manufacturing</span></span>](production-configure-production-processes.md)  
[<span data-ttu-id="0df63-111">Production</span><span class="sxs-lookup"><span data-stu-id="0df63-111">Manufacturing</span></span>](production-manage-manufacturing.md)  
[<span data-ttu-id="0df63-112">STOCKS ET EN-COURS</span><span class="sxs-lookup"><span data-stu-id="0df63-112">Inventory</span></span>](inventory-manage-inventory.md)  
[<span data-ttu-id="0df63-113">Achats</span><span class="sxs-lookup"><span data-stu-id="0df63-113">Purchasing</span></span>](purchasing-manage-purchasing.md)  
[<span data-ttu-id="0df63-114">Détails de conception : planification de l’approvisionnement</span><span class="sxs-lookup"><span data-stu-id="0df63-114">Design Details: Supply Planning</span></span>](design-details-supply-planning.md)  
[<span data-ttu-id="0df63-115">Pratiques de configuration recommandées : planification de l’approvisionnement</span><span class="sxs-lookup"><span data-stu-id="0df63-115">Setup Best Practices: Supply Planning</span></span>](setup-best-practices-supply-planning.md)  
<span data-ttu-id="0df63-116">[Utilisation de [!INCLUDE[prod_short](includes/prod_short.md)]](ui-work-product.md)</span><span class="sxs-lookup"><span data-stu-id="0df63-116">[Working with [!INCLUDE[prod_short](includes/prod_short.md)]](ui-work-product.md)</span></span>
