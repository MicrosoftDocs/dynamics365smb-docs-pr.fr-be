...
Lorsqu’un client souhaite connaître le prix d’un projet qui sera facturé en fonction de l’activité, vous devez déterminer les coûts budgétés du projet. Utilisez cette opération sur la page **Lignes tâche projet**.
