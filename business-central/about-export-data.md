...
Si vous souhaitez exporter toutes vos transactions financières, le volume de données est alors très important et l’exportation prend souvent plusieurs minutes. Les transactions financières sont affichées sur la page **Écritures comptables**.  
