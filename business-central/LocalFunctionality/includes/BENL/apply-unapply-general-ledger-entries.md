...
## <a name="to-view-the-applied-general-ledger-entries"></a><a name="to-view-the-applied-general-ledger-entries"></a><a name="to-view-the-applied-general-ledger-entries"></a>Pour afficher les écritures comptables lettrées
