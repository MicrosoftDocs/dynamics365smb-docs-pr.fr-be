...
ms.author: edupont
---
# <a name="belgian-coda-bank-statements-in-the-belgian-version"></a><a name="belgian-coda-bank-statements-in-the-belgian-version"></a>Relevés bancaires CODA belges dans la version belge
...
## <a name="applying-statement-lines"></a><a name="applying-statement-lines"></a>Lettrage des lignes relevé
...
## <a name="extending-the-coda-integration"></a><a name="extending-the-coda-integration"></a>Extension de l'intégration CODA
