...
ms.author: edupont
---
# <a name="export-payment-files-in-the-belgian-version"></a><a name="export-payment-files-in-the-belgian-version"></a><a name="export-payment-files-in-the-belgian-version"></a>Exporter des fichiers de paiement dans la version belge
...
## <a name="to-print-a-payment-file"></a><a name="to-print-a-payment-file"></a><a name="to-print-a-payment-file"></a>Pour imprimer un fichier de paiement
