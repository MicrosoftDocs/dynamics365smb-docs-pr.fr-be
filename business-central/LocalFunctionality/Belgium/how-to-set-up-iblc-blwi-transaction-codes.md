...
ms.author: edupont
---
# <a name="set-up-iblc-blwi-transaction-codes-in-the-belgian-version"></a><a name="set-up-iblc-blwi-transaction-codes-in-the-belgian-version"></a><a name="set-up-iblc-blwi-transaction-codes-in-the-belgian-version"></a>Configurer des codes transaction IBLC-BLWI dans la version belge
...
## <a name="to-set-up-iblcblwi-transaction-codes"></a><a name="to-set-up-iblcblwi-transaction-codes"></a><a name="to-set-up-iblcblwi-transaction-codes"></a>Pour configurer les codes transaction IBLC/BLWI
