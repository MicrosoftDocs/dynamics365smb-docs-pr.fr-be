...
ms.author: edupont
---
# <a name="belgian-electronic-payments"></a><a name="belgian-electronic-payments"></a>Paiements électroniques, Belgique
...
## <a name="activate-sepa-payments-in-the-belgian-version"></a><a name="activate-sepa-payments-in-the-belgian-version"></a>Activer des paiements SEPA dans la version belge
...
## <a name="file-non-euro-sepa-payments"></a><a name="file-non-euro-sepa-payments"></a>Effectuer des paiements SEPA hors euro
...
## <a name="to-file-a-non-euro-sepa-payment"></a><a name="to-file-a-non-euro-sepa-payment"></a>Pour effectuer un paiement SEPA hors euro
...
## <a name="correcting-payment-lines"></a><a name="correcting-payment-lines"></a>Correction des lignes de paiement
