...
ms.author: edupont
---
# <a name="belgian-electronic-payments" />Paiements électroniques, Belgique
...
## <a name="activate-sepa-payments-in-the-belgian-version" />Activer des paiements SEPA dans la version belge
...
## <a name="file-non-euro-sepa-payments" />Effectuer des paiements SEPA hors euro
...
## <a name="to-file-a-non-euro-sepa-payment" />Pour effectuer un paiement SEPA hors euro
...
## <a name="correcting-payment-lines" />Correction des lignes de paiement
