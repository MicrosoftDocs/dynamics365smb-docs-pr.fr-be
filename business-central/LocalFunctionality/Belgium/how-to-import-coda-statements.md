...
ms.author: edupont
---
# <a name="import-coda-statements-in-the-belgian-version" />Importer des relevés bancaires CODA dans la version belge
...
## <a name="to-import-a-coda-statement" />Pour importer un relevé CODA
