...
ms.author: edupont
---
# <a name="print-periodic-vat-reports-in-the-belgian-version"></a><a name="print-periodic-vat-reports-in-the-belgian-version"></a>Imprimer les déclarations de TVA périodiques dans la version belge
...
## <a name="to-print-the-monthlyquarterly-declaration"></a><a name="to-print-the-monthlyquarterly-declaration"></a>Pour imprimer la déclaration mensuelle/trimestrielle
...
## <a name="to-print-the-vat-annual-listing-on-disk"></a><a name="to-print-the-vat-annual-listing-on-disk"></a>Pour imprimer la liste annuelle de TVA sur disque
...
## <a name="to-print-the-vat-vies-declaration-report-to-disk"></a><a name="to-print-the-vat-vies-declaration-report-to-disk"></a>Pour imprimer l'état TVA - Déclaration intracommunautaire sur disque
