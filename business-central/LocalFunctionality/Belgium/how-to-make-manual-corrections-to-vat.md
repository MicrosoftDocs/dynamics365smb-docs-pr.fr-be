...
ms.author: edupont
---
# <a name="make-manual-corrections-to-vat-in-the-belgian-version" />Corrections manuelles de la TVA dans la version belge
...
## <a name="to-make-manual-corrections-to-vat" />Pour apporter des corrections manuelles à la TVA
