...
ms.author: edupont
---
# <a name="set-up-declaration-types-in-the-belgian-version" />Paramétrer des types de déclarations dans la version belge
...
## <a name="to-set-up-declaration-types" />Pour paramétrer des types de déclarations
