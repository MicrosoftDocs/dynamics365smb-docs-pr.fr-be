...
ms.author: edupont
---
# <a name="set-up-declaration-types-in-the-belgian-version"></a><a name="set-up-declaration-types-in-the-belgian-version"></a><a name="set-up-declaration-types-in-the-belgian-version"></a>Paramétrer des types de déclarations dans la version belge
...
## <a name="to-set-up-declaration-types"></a><a name="to-set-up-declaration-types"></a><a name="to-set-up-declaration-types"></a>Pour paramétrer des types de déclarations
