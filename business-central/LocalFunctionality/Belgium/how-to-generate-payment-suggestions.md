...
ms.author: edupont
---
# <a name="generate-payment-suggestions-in-the-belgian-version" />Générer des suggestions de règlement dans la version belge
...
## <a name="to-generate-payment-suggestions" />Pour générer des suggestions de règlement
