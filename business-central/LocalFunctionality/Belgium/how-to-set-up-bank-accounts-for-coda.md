...
Avant de pouvoir commencer à utiliser la fonctionnalité bancaire électronique pour les relevés CODA, vous devez configurer les codes suivants :  
...
## <a name="to-set-up-protocol-numbers-and-version-codes"></a>Pour configurer les numéros de protocole et les codes de version  
...
3.  Dans le raccourci **Validation**, remplissez les champs comme décrit dans le tableau suivant.  
    ...
    |**Code version**|Saisissez le code version utilisé par le système CODA pour importer les relevés de comptes bancaires codés.|  
