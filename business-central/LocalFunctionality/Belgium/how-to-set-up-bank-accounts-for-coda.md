...
ms.author: edupont
---
# <a name="set-up-bank-accounts-for-coda-in-the-belgian-version"></a><a name="set-up-bank-accounts-for-coda-in-the-belgian-version"></a><a name="set-up-bank-accounts-for-coda-in-the-belgian-version"></a>Configurer des comptes bancaires pour CODA dans la version belge
...
## <a name="to-set-up-protocol-numbers-and-version-codes"></a><a name="to-set-up-protocol-numbers-and-version-codes"></a><a name="to-set-up-protocol-numbers-and-version-codes"></a>Pour configurer des numéros de protocole et des codes version
