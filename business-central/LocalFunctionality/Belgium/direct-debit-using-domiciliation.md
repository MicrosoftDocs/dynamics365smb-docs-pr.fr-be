...
ms.author: edupont
---
# <a name="direct-debit-using-domiciliation" />Domiciliation européenne
...
## <a name="set-up-domiciliations" />Paramétrer les domiciliations
...
### <a name="to-set-up-domiciliation" />Pour configurer une domiciliation
...
## <a name="generate-domiciliation-suggestions" />Générer des suggestions de domiciliation
...
### <a name="to-generate-domiciliation-suggestions" />Pour générer des suggestions de domiciliation
...
## <a name="edit-and-delete-domiciliation-lines" />Modifier et supprimer des lignes de domiciliation
...
### <a name="to-edit-a-journal-line" />Pour modifier une ligne feuille
...
### <a name="to-delete-a-journal-line" />Pour supprimer une ligne feuille
...
## <a name="test-domiciliations" />Tester les domiciliations
...
### <a name="to-print-a-domiciliation-test-report" />Pour imprimer un état de test de domiciliation
...
## <a name="export-and-post-domiciliations" />Exporter et valider les domiciliations
...
### <a name="to-export-and-post-domiciliations" />Pour exporter et valider les domiciliations
