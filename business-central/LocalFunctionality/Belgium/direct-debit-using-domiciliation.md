...
ms.author: edupont
---
# <a name="direct-debit-using-domiciliation"></a><a name="direct-debit-using-domiciliation"></a>Domiciliation européenne
...
## <a name="set-up-domiciliations"></a><a name="set-up-domiciliations"></a>Paramétrer les domiciliations
...
### <a name="to-set-up-domiciliation"></a><a name="to-set-up-domiciliation"></a>Pour configurer une domiciliation
...
## <a name="generate-domiciliation-suggestions"></a><a name="generate-domiciliation-suggestions"></a>Générer des suggestions de domiciliation
...
### <a name="to-generate-domiciliation-suggestions"></a><a name="to-generate-domiciliation-suggestions"></a>Pour générer des suggestions de domiciliation
...
## <a name="edit-and-delete-domiciliation-lines"></a><a name="edit-and-delete-domiciliation-lines"></a>Modifier et supprimer des lignes de domiciliation
...
### <a name="to-edit-a-journal-line"></a><a name="to-edit-a-journal-line"></a>Pour modifier une ligne feuille
...
### <a name="to-delete-a-journal-line"></a><a name="to-delete-a-journal-line"></a>Pour supprimer une ligne feuille
...
## <a name="test-domiciliations"></a><a name="test-domiciliations"></a>Tester les domiciliations
...
### <a name="to-print-a-domiciliation-test-report"></a><a name="to-print-a-domiciliation-test-report"></a>Pour imprimer un état de test de domiciliation
...
## <a name="export-and-post-domiciliations"></a><a name="export-and-post-domiciliations"></a>Exporter et valider les domiciliations
...
### <a name="to-export-and-post-domiciliations"></a><a name="to-export-and-post-domiciliations"></a>Pour exporter et valider les domiciliations
