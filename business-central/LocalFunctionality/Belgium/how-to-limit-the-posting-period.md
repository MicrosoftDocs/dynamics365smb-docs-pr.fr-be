...
---
# Limiter la période de validation dans la version belge
...
## Pour limiter les périodes de validation par société  
...
## Pour limiter les périodes de validation par utilisateur  
...
## Pour limiter les périodes de validation par modèle  
