...
ms.author: edupont
---
# <a name="limit-the-posting-period-in-the-belgian-version" />Limiter la période de validation dans la version belge
...
## <a name="to-limit-the-posting-periods-by-company" />Pour limiter les périodes de validation par société
...
## <a name="to-limit-the-posting-periods-by-user" />Pour limiter les périodes de validation par utilisateur
...
## <a name="to-limit-the-posting-periods-by-template" />Pour limiter les périodes de validation par modèle
