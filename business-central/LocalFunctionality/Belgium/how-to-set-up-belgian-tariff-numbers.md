...
ms.author: edupont
---
# <a name="set-up-belgian-tariff-numbers-in-the-belgian-version" />Paramétrer les nomenclatures produits belges dans la version belge

Les autorités douanières et fiscales belges ont établi un code article à 8 chiffres pour diverses nomenclatures produits.  

## <a name="to-set-up-tariff-numbers" />Pour paramétrer les nomenclatures produits
