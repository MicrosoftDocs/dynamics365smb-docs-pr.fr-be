...
ms.author: edupont
---
# <a name="set-up-vendors-for-automatic-payment-suggestions-in-the-belgian-version"></a><a name="set-up-vendors-for-automatic-payment-suggestions-in-the-belgian-version"></a>Paramétrer les fournisseurs pour des suggestions de règlement automatique dans la version belge
...
## <a name="to-set-up-a-vendor-to-be-included-in-the-payment-suggestion-batch"></a><a name="to-set-up-a-vendor-to-be-included-in-the-payment-suggestion-batch"></a>Pour paramétrer un fournisseur pour l'inclure dans le traitement par lots de suggestion de paiement
