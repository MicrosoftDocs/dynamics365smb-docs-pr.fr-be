...
ms.author: edupont
---
# <a name="set-up-vendors-for-automatic-payment-suggestions-in-the-belgian-version" />Paramétrer les fournisseurs pour des suggestions de règlement automatique dans la version belge
...
## <a name="to-set-up-a-vendor-to-be-included-in-the-payment-suggestion-batch" />Pour paramétrer un fournisseur pour l'inclure dans le traitement par lots de suggestion de paiement
