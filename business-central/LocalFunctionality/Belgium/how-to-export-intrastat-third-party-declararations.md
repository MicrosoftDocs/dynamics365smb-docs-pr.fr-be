...
ms.author: soalex
---
# <a name="export-intrastat-third-party-declarations-in-the-belgian-version" />Exporter des déclarations tierces intracommunautaires dans la version belge
...
## <a name="to-export-the-third-party-declaration" />Pour exporter la déclaration tierce
