...
ms.author: edupont
---
# <a name="create-payment-journal-templates-and-batches-in-the-belgian-version" />Création de modèles et de lots de feuilles paiement dans la version belge
...
## <a name="to-create-a-payment-journal-template" />Pour créer un modèle feuille paiement
...
## <a name="to-add-payment-journal-batches-to-the-journal-template" />Pour ajouter des feuilles paiement au modèle feuille
