---
title: 'Comment configurer les protocoles d’exportation [BE]'
description: 'Avant d’utiliser les services bancaires électroniques, vous devez configurer des protocoles d’exportation qui définissent le format du fichier généré lorsque la banque traite l’historique des paiements d’exportation.'
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
---
# <a name="set-up-export-protocols-in-the-belgian-version"></a>Mettre en place des protocoles d’exportation dans la version belge
...
|2000005 Vérifiez les paiements SEPA non-euro|Rapport 2000006 Fichier Paiements SEPA non-Euro|  
|2000007 Vérifiez les paiements SEPA 001.001.09|Rapport 2000008 Fichier FCY SEPA 001.001.09 Paiements|
|Si vous ne voulez pas cette option, définissez-la sur zéro ; sinon, Sélectionner une autre option.|XMLport 1000 (Paiements SEPA pain.001.001.03)|  
