...
ms.author: edupont
---
# <a name="set-up-export-protocols-in-the-belgian-version" />Paramétrer les protocoles d'exportation dans la version belge
...
## <a name="to-set-up-an-export-protocol" />Pour paramétrer un protocole d'exportation
