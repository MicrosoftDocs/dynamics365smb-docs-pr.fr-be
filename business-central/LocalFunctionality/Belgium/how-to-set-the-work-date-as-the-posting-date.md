...
ms.author: edupont
---
# <a name="set-the-work-date-as-the-posting-date-in-the-belgian-version" />Comment définir la date de travail comme date de validation dans la version belge
...
## <a name="to-set-the-work-date-as-the-posting-date" />Pour définir la date de travail comme date de validation
