...
ms.author: edupont
---
# <a name="set-the-work-date-as-the-posting-date-in-the-belgian-version"></a><a name="set-the-work-date-as-the-posting-date-in-the-belgian-version"></a>Comment définir la date de travail comme date de validation dans la version belge
...
## <a name="to-set-the-work-date-as-the-posting-date"></a><a name="to-set-the-work-date-as-the-posting-date"></a>Pour définir la date de travail comme date de validation
