...
Dans [!INCLUDE[d365fin](../../includes/d365fin_md.md)], vous pouvez exporter des déclarations D.E.B dans un fichier que vous pouvez envoyer au portail OneGate. Pour plus d'informations, voir [Exporter les déclarations de tiers intracomm.](how-to-export-intrastat-third-party-declararations.md).  
