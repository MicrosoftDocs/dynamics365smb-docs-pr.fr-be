...
ms.author: edupont
---
# <a name="set-up-intrastat-establishment-numbers-in-the-belgian-version" />Configurer les numéros d'établissement intracomm. dans la version belge
...
## <a name="to-set-up-an-intrastat-establishment-number" />Pour configurer un numéro établissement intracommunautaire
