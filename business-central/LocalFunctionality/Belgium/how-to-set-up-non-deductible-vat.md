...
ms.author: edupont
---
# <a name="set-up-non-deductible-vat-in-the-belgian-version"></a><a name="set-up-non-deductible-vat-in-the-belgian-version"></a><a name="set-up-non-deductible-vat-in-the-belgian-version"></a>Paramétrer la TVA non déductible dans la version belge
...
## <a name="to-set-up-the-non-deductible-vat-percentage"></a><a name="to-set-up-the-non-deductible-vat-percentage"></a><a name="to-set-up-the-non-deductible-vat-percentage"></a>Pour définir le pourcentage de TVA non déductible
