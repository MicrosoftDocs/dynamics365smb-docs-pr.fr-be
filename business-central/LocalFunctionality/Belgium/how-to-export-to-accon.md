...
ms.author: edupont
---
# <a name="export-to-accon-in-the-belgian-version" />Exporter vers Accon dans la version belge
...
## <a name="to-export-the-link-to-accon-report" />Pour exporter l'état Lien avec Accon
