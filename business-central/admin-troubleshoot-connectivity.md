...
## <a name="basic-internet-connectivity"></a>Connectivité Internet de base
...
|Problème|Choses à essayer|
|-------|-------------|
|Aucun utilisateur authentifié n’a pu effectuer cette vérification pour|Voir la vérification **Authentification utilisateur**.|
...
|Aucune adresse de cluster pour laquelle effectuer cette vérification|Consultez la liste des environnements disponibles dans le centre d’administration de Business Central.|
