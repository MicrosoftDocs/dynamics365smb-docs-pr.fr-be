...
|Date validation|Type écriture|Montant (réel)|Quantité|N° d’écriture|  
|------------|----------|--------------------|--------|---------|  
|01/01/20|Achats|80.00|10|0|  

### <a name="value-entries-1"></a>Écritures valeur (1)

|Date validation|Type écriture|Montant (réel)|N° écriture comptable article|Numéro de la séquence|  
|------------|----------|--------------------|---------------------|---------|  
|01/01/20|Coût direct|70,00|1|0|  
|01/01/20|Coût indirect|10.00|0|2|  

### <a name="item-application-entries-1"></a>Écritures lettrage article (1)

|N° d’écriture|N° écriture comptable article|N° écriture article entrant|N° écriture article sortant|Quantité|  
|---------|---------------------|----------------------|-----------------------|--------|  
|1|1|1|0|10|  
...
|Date validation|Type écriture|Montant (réel)|N° écriture comptable article|N° d’écriture|  
|------------|----------|--------------------|---------------------|---------|  
...
|Date validation|Type écriture|Montant (réel)|Coût validé en comptabilité|N° écriture comptable article|Numéro de la séquence|  
|------------|----------|--------------------|------------------|---------------------|---------|  
...
|Date validation|Compte général|N° compte (démonstration Fr-FR)|Montant|N° d’écriture|  
|------------|-----------|------------------------|------|---------|  
...
|N° écriture comptable|N° écriture valeur|N° hist. transaction compta.|  
|-------------|---------------|----------------|  
|0|0|0|  
|2|0|0|  
|3|2|0|  
