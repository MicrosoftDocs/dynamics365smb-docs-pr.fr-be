...
Vous pouvez imprimer ces documents à tout moment, les libérer et les rouvrir, et attribuer des valeurs communes, y compris des dimensions, dans l’en-tête. Pour réimprimer les documents après leur publication, utilisez les pages **Réception d’inventaire validée** et **Expédition du stock validé**.
