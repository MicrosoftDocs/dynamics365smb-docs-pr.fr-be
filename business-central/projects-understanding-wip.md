...
Pour effectuer le suivi de la valeur dans la comptabilité, vous pouvez calculer les TEC et valider la valeur en comptabilité. Pour plus d’informations, voir [Surveiller la progression et les performances projet](projects-how-monitor-progress-performance.md).
