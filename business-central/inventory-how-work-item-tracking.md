...
|**Quantité suspendue actuelle**|Nombre d’articles demandés qui seront utilisés dans le document actuel, mais qui ne sont pas validés.|
...
> [!NOTE]
> [!INCLUDE [prod_short](includes/prod_short.md)] vérifie que chaque ligne possède une combinaison unique de numéros de série, de lot et/ou de colis. Si vous souhaitez fractionner un lot, un package ou un lot et un package en plusieurs lots ou packages, vous devez utiliser plusieurs lignes feuille.

1. Sélectionnez ![l’icône en forme d’Ampoule qui ouvre la fenêtre de recherche.](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire") Icône, entrez **Journaux de reclassement d’articles**, puis choisissez le lien associé.  
...
|Traçabilité     |* Filtre n° de série<br><br>* Filtre n° lot<br><br>* N° paquet Filtre |
