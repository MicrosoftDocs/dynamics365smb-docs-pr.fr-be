...
ms.reviewer: jswymer
---
# <a name="set-the-layout-used-by-a-report"></a>Définition de la présentation utilisée par un état
...
1. Sélectionnez l’icône en forme ![d’Ampoule qui ouvre la fenêtre de recherche 1.](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire") entrez **Sélection présentation état**, puis sélectionnez le lien associé.
