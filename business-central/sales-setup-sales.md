...
| Configurer votre e-mail de sorte qu'il contienne un résumé des informations du document vente qui est envoyé. |[Envoi de documents par courrier électronique](ui-how-send-documents-email.md) |
...
|Entrer des informations sur les différents transporteurs utilisés, notamment un lien vers les prestations de traçabilité des colis.|[Configuration des transporteurs](sales-how-to-set-up-shipping-agents.md)|
