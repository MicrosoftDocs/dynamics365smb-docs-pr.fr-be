...
|Préparez les centres de charge et les gammes à représenter les opérations de production sous-traitées.|[Sous-traitance de la production](production-how-to-subcontract-manufacturing.md)|  
