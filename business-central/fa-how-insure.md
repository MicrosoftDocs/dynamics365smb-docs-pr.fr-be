...
La procédure suivante explique comment créer une ligne feuille assurance manuellement. Si le bouton **Publication automatique d’assurance** est activé sur la page **Configuration des immobilisations**, les lignes du journal d’assurance sont automatiquement créées lorsque vous comptabilisez les frais d’acquisition. Dans ce cas, tout ce que vous avez à faire consiste à valider la feuille.  

1. Sélectionnez ![l’icône en forme d’Ampoule qui ouvre la fenêtre de recherche](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire"), entrez **Feuille assurance**, puis choisissez le lien associé.  
...
1. Sélectionnez l’icône ![Ampoule qui ouvre la fenêtre de recherche](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire"), entrez **Réévaluer assurance**, puis choisissez le lien associé.
...
4. Sélectionnez ![icône en forme d’Ampoule qui ouvre la fenêtre de recherche.](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire") entrez **Feuille assurance**, puis choisissez le lien associé.  
...
1. Sélectionnez ![l’icône en forme d’Ampoule qui ouvre la fenêtre de recherche](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire"), entrez **Assurance**, puis choisissez le lien associé.  
