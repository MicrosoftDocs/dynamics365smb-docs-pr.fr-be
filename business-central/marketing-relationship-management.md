...
|Définissez les entités externes avec lesquelles vous entretenez des relations commerciales. Par exemple, les clients, les clients potentiels, les fournisseurs, les avocats et les consultants, soit en tant que type de personne, soit en tant que type d’entreprise.|[Gestion de contacts](marketing-contacts.md)|
...
|Utilisez Dynamics 365 Sales pour Customer Engagement pour le traitement intégration transparente dans le processus allant du prospect à l'encaissement. Utiliser [!INCLUDE [prod_short](includes/prod_short.md)] pour les activités backend telles que le traitement des commandes, la gestion des stocks et la gestion de vos finances.|[Intégration à Dynamics 365 Sales](marketing-integrate-dynamicscrm.md)|
