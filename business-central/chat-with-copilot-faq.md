...
## Copilot trouve-t-il des données dans d’autres entreprises ou environnements ?

Même si votre organisation utilise plusieurs environnements ou entreprises pour séparer les données, Copilot recherche uniquement les enregistrements de l’entreprise à laquelle vous êtes actuellement connecté.
