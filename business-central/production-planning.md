...
|Créer des ordres de fabrication de projet ou un à un à partir d’une commande vente pour couvrir la demande exacte des commandes vente.|[Création d’un O.F. à partir de commandes vente](production-how-to-create-production-orders-from-sales-orders.md)|
...
|Utiliser la page **Feuille planning** pour exécuter les options PDP et MRP pour créer automatiquement un programme d'approvisionnement détaillé à tous les niveaux d'article.|[Exécution d’une planification complète, d’une PDP ou d’une MRP](production-how-to-run-mps-and-mrp.md)|
...
|Afficher le stock disponible prévu sous différents types d'affichage et voir quels besoins bruts, réceptions de commandes planifiées et autres événements l'influencent dans le temps.|[Afficher la disponibilité des articles](inventory-how-availability-overview.md)|  
