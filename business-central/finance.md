...
|Ventiler une écriture d'une feuille comptabilité dans différents comptes lorsque vous validez la feuille. |[Ventilation des coûts et des bénéfices](year-allocate-costs-income.md) |
...
| Configurer des états financiers entre les divisions ou les entités juridiques. | [Gestion des états financiers entre les divisions ou les entités juridiques](finance-consolidated-company-reporting.md) |
| Configurer États financiers pour produire des états et des vues d'ensemble. | [Préparation de l’état financier](bi-how-work-account-schedule.md) |
| Effectuez une analyse ad hoc des données financières directement sur les pages de liste et les requêtes. | [Analyse ad hoc sur les données financières](ad-hoc-analysis-finance.md) |
...
| Explorer États financiers clés intégrés. | [États financiers clés intégrés](finance-reports.md) |
| Explorez états clés intégrés sur les immobilisations. | [États sur les immobilisations intégrés](fa-reports.md) |
| Explorer États clés des comptes clients intégrés. | [États des comptes clients intégrés](receivables-reports.md)
| Explorer États des comptes fournisseurs intégrés. | [États des comptes fournisseurs intégrés](payables-reports.md)
...
| Pour... | Voir |
| --- | --- |
|Calculer la taxe sur la valeur ajoutée (TVA) sur les transactions de vente et d’achat afin de pouvoir déclarer les montants aux autorités fiscales.|[Utilisation de la TVA sur les ventes et les achats](finance-work-with-vat.md)|
|Préparer une déclaration qui répertorie la TVA des ventes, et envoyer la déclaration à l’administration fiscale de l’UE. | [Déclaration de TVA aux autorités fiscales](finance-how-report-vat.md)|
