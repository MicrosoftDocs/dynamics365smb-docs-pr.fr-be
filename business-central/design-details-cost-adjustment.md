...
|Date validation|Type écriture comptable article|Montant (réel)|Coût validé en comptabilité|Quantité facturée|Numéro de la séquence|  
|------------|----------------------|--------------------|------------------|-----------------|---------|  
...
|Date validation|Type écriture comptable article|Montant (réel)|Coût validé en comptabilité|Quantité facturée|Ajustement|Numéro de la séquence|  
|------------|----------------------|--------------------|------------------|-----------------|----------|---------|  
