...
| Effectuez des transactions dans plusieurs devises. | Assurez-vous que les états financiers dans différentes devises sont exacts et utilisent des taux de change corrects. | [Mise à jour des taux de change devise](finance-how-update-currencies.md) |
...
| Analysez les données dans Excel. | Recherchez des faits, dépannez et effectuer des analyses ad hoc dans Microsoft Excel. | [Analyse des états financiers dans Excel](finance-analyze-excel.md) |
...
| Utilisez des processus sans papier. | Évitez les frais d′envoi, de réception et d′impression des documents. | [Documents entrants](across-income-documents.md)<br><br> [Gestion les documents joints, des liens et des notes sur les cartes et les documents](ui-how-add-link-to-record.md) |
