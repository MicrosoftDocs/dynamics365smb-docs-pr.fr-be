...
description: 'Comment suivre la consommation d’heures salarié, d’heures machines, d’articles en stock et d’autres types d’activité au fur et à mesure de l’avancée du projet.'
author: brentholtorf
ms.author: bholtorf
...
6. Sur le **Projet Calculer l’en-cours** , vous sélectionnez un projet pour lequel calculer l’en-cours. Dans le raccourci **Projet**, sélectionnez **Deerfield** dans le champ **N°** .  
...
1.  Sélectionnez ![l’icône en forme d’Ampoule qui ouvre la fenêtre de recherche](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire"), entrez **Cockpit TEC projet**, puis choisissez le lien associé.  
...
> [!NOTE]  
> Les en-cours et la comptabilisation sont calculés mais ne sont pas comptabilisés dans le grand livre. Pour ce faire, exécutez le traitement par lots **Valider TEC en compta.** à l'issue du calcul des TEC et de la reconnaissance.
...
11. Dans la liste **Projets**, sélectionnez le projet **Deerfield**, choisissez l’action **TEC**, puis l’action **Écritures compta. TEC**. La case du champ **Contre-passé** des écritures TEC est cochée.  
