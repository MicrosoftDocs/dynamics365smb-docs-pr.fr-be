...
## <a name="calculate-and-post-project-completion-entries"></a>Calculer et valider les écritures d’achèvement du projet
...
## <a name="view-project-ledger-entries"></a>Visualiser des écritures comptables projet
