...
|Option|Description|  
|--------------------|------------|  
|**Bloqué à la vente**|Vous ne pouvez pas choisir l’article ou la variante dans un document vente ou une feuille article vente.|  
|**Bloqué à l'achat**|Vous ne pouvez pas choisir l’article ou la variante dans un document achat, une feuille article achat, ou dans les processus de planification achat.|  
