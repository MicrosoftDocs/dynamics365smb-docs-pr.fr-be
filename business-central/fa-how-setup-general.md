...
Un modèle est une présentation de feuille prédéfinie. Le modèle affiche des informations sur les codes suivi, les états et les souches de numéros. Pour en savoir plus, reportez-vous à [Utiliser des feuilles comptabilité](ui-work-general-journals.md).
...
## <a name="to-set-up-fixed-asset-allocation-keys-optional"></a>Pour configurer les clés de ventilation d’immobilisations (facultatif)
...
## <a name="to-set-up-fixed-asset-journal-batches-optional"></a>Pour configurer les lots feuille immobilisation (facultatif)
...
1. Sélectionnez ![l’icône en forme d’Ampoule qui ouvre la fenêtre de recherche](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire") entrez **Modèles feuille immo.**, puis sélectionnez le lien associé.  
...
## <a name="to-set-up-fixed-asset-reclassification-journal-templates-optional"></a>Pour configurer des modèles feuille reclassement immobilisation (facultatif)
...
## <a name="to-set-up-fixed-asset-reclassification-journal-batches-optional"></a>Pour configurer les lots feuille reclassement immobilisation (facultatif)
