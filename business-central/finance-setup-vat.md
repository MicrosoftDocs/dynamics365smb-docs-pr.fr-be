...
1. Sélectionnez l’icône en forme ![d’Ampoule qui ouvre la fenêtre de recherche 1.](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire") , entrez **Paramètres utilisateur**, puis choisissez le lien associé.  
2. Dans le champ **ID utilisateur**, spécifiez l’utilisateur que vous souhaitez autoriser à publier au cours d’une période spécifique.  
