...
|Effectuez la facturation en vrac des rendez-vous créés dans Microsoft Bookings.|[Facturation en nombre pour Microsoft Bookings](finance-bookings.md)|
...
|Configurez et affecter un calendrier principal à votre société et à ses partenaires commerciaux, tels que ses clients, ses fournisseurs ou ses magasins. Les dates de livraison et de réception sur les lignes commande vente, commande achat, ordre de transfert, et ordre de fabrication sont ensuite calculées en fonction des jours ouvrés définis dans le calendrier.|[Configuration des calendriers de base](across-how-to-assign-base-calendars.md)|
