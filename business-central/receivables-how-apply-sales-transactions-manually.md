...
* En renseignant le champ **N° doc. lettrage** sur les documents Avoir vente. Pour plus d’informations, voir [Pour appliquer une note de crédit à une seule écriture comptable client](#to-apply-a-credit-memo-to-a-single-customer-ledger-entry).
* Grâce à l'action **Définir ID lettrage** d'une écriture comptable client. Pour plus d’informations, voir [Pour imputer un paiement à une seule écriture comptable client](#to-apply-a-payment-to-a-single-customer-ledger-entry).
...
1. Sélectionnez l’icône ![Ampoule qui ouvre la fenêtre de recherche.](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire") saisissez **Feuille règlement**, puis choisissez le lien associé.
...
1. Sélectionnez ![l’icône en forme d’Ampoule qui ouvre la fenêtre de recherche](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire"), , saisissez **Journal des encaissements** et choisissez le lien associé.
2. Sélectionnez **Modifier journal**.
...
1. Sélectionnez ![icône en forme d’Ampoule qui ouvre la fenêtre de recherche.](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire") entrez **Avoirs vente**, puis sélectionnez le lien associé.
...
1. Sélectionnez ![l’icône en forme d’Ampoule qui ouvre la fenêtre de recherche](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire"), entrez **Avoirs vente**, puis sélectionnez le lien associé.
2. Ouvrez l'avoir vente souhaité.
...
1. Sélectionnez ![l’icône en forme d’Ampoule qui ouvre la fenêtre de recherche](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire") saisissez **Feuille règlements**, puis choisissez le lien associé.
