---
title: "Paramétrer la messagerie dans Business\_Central"
...
> [!NOTE]
> Si vous utilisez l’authentification de service à service (S2S), le Microsoft 365 et Les connecteurs d’utilisateurs actuels ne peuvent pas authentifier l’utilisateur lorsqu’il envoie un document de vente ou d’achat par e-mail. Lorsque quelqu’un envoie un document, le message d’erreur suivant s’affiche :
>
...
>
> Le problème est dû aux actions liées sur les API de document qui envoient des e-mails. Pour en savoir plus sur les actions liées, accédez à [Actions liées](/dynamics365/business-central/dev-itpro/api-reference/v2.0/resources/dynamics_salesinvoice#bound-actions). 
>
